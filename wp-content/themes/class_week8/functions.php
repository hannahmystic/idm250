 ...
 * @link https://codex.wodpress.org/Post_Thumnails
 */

 add_theme_support('post-thumbnails');

// CHange the default "Default temlpate" name given for wordpress. 
// link: https://codex.wordpress.org/Plugin_API/Filter_Reference/default_page_tamplate_title
 add_filter('default_page_template_title', function () {
     return __('Generallllll');
 });