...
<section id="home-banner" style="background-image: url(<?php echo get_field('hero_image'); ?>);">
  <div class="content">
    <div class="container"  data-wow-duration="1s">
      <h1 class="wow fadeInUp"> <?php echo get_field('hero_title');?></h1>
      <h2 class="wow fadeInUp"> <?php echo get_field('hero_subtitle');?> </h2>
      <p class="wow fadeInUp"> <?php echo get_field('hero_intro');?> </p>
      <a class="btn btn-outline-default wow fadeInLeft" href="#"><?php echo get_field('hero_button_primary_label'); ?> </a> <a class="btn btn-info chooser-btn wow fadeInRight" href="#">  <?php echo get_field('hero_button_primary_url'); ?>  </a> </div>
  </div>
</section>
    ...
    <div class="row"> 
      ...
      <div class="works">
        <ul class="grid wow zoomIn">
          ...
          <li>
            <figure><img src="dist/img/04-screenshot.jpg" alt="Screenshot 01">
              <figcaption>
                <div class="caption-content">
                  <h6>Optimised For Design</h6>
                  <a href="#">Design</a> <a href="#">brand</a>
          ...
          <li>
            <figure><img src="dist/img/06-screenshot.jpg" alt="Screenshot 01">
              <figcaption>
                <div class="caption-content">
                  <h6>Optimised For Design</h6>
                  <a href="#">Design</a> <a href="#">brand</a>
